        ...
        <tbody>
            ...
            <?php foreach ($allCategories as $currentCategory): ?>
                <tr>
                    ...
                    <td class="text-right">
                        <a href="<?= $router->generate('category-update', ['idCategory' => $currentCategory->getId()]); ?>" class="btn btn-sm btn-warning">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?= $router->generate('category-delete', ['idCategory' => $currentCategory->getId()]) . '?token=' . $_SESSION['token']; ?>">Oui, je veux supprimer</a>
